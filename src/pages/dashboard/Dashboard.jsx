    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
        {cards.map((c) => (
          <div
            key={c.title}
            className="group bg-[#111] border border-white/10 rounded-2xl p-6
                       hover:border-green-400/50 transition"
          >
            <div
              className="w-12 h-12 rounded-xl bg-green-400/10
                            text-green-400 flex items-center justify-center mb-4"
            >
              {c.icon}
            </div>
